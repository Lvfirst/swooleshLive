...
class Ucpaas
{
    ...
    public function SendSms($templateid,$param=null,$mobile,$uid){
        ...
        $body_json = array(
            'sid'=>$this->accountSid,
            'token'=>$this->token,
            'appid'=>'09c74696a08c424386767dd7a36911a3',
...
$appid = "09c74696a08c424386767dd7a36911a3";    //应用的ID，可在开发者控制台内的短信产品下查看
$templateid = "180722";    //可在后台短信产品→选择接入的应用→短信模板-模板ID，查看该模板ID
$param ='lvzhiwei,9999'; //多个参数使用英文逗号隔开（如：param=“a,b,c”），如为参数则留空
$mobile = 18686130812;

//70字内（含70字）计一条，超过70字，按67字/条计费，超过长度短信平台将会自动分割为多条发送。分割后的多条短信将按照具体占用条数计费。

echo $ucpass->SendSms($templateid,$param,$mobile,$uid);*/